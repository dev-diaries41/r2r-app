...
import {DialogueDoubleAlert, DialogueAlert} from '../../components';
...
const SubletterSettings = ({navigation}) => {
  ...
  const [reauthenticateUser, setReautheticateUser] = useState(false);
  ...
  return (
    ...
    backgroundColor: dark? themes.dark.background : themes.light.background,
      ...
      <ScrollView contentContainerStyle={[styles.container, {opacity: reauthenticateUser || changingPassword? 0.3 : 1}]}>
        ...
        <View
          ...
          >           
          <SettingsCard
            onPress={handleUpdateSettings}    //{/* {placeholder function} */}           
            dark={dark}
        ...
        <SettingsCard
          ...
          />  
        <SettingsCard
            onPress={()=>setReautheticateUser(true)}            
            dark={dark}
      ...
      <CustomAlert/>
      <DialogueAlert 
      visible={reauthenticateUser}
      onClose = {()=>setReautheticateUser(false)}
...
export default SubletterSettings;
